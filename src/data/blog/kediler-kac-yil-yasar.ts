...
export const kedilerKacYilYasar: BlogYazi = {
  ...
  kontrolListesi: [
    'Aşı tekrar tarihleri kayıtlı mı?',
    'Kısırlaştırıldıysa porsiyon azaldı mı?',
    'Kaburga testiyle kilo bakıldı mı?',
    'İç ve dış parazit aksadı mı?',
    'Son kontrol bir yıl içinde mi?',
    'Ağız içi ve diş taşı bakıldı mı?',
  ],
  sss: [
