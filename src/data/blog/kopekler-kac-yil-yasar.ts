...
export const kopeklerKacYilYasar: BlogYazi = {
  ...
  sss: [
    ...
    { soru: 'Köpekler için mide dönmesi neden acil?', cevap: 'Derin göğüslü ve dev ırklarda mide dönüp gaz sıkışabiliyor. Karında şişkinlik, kusmaya çalışıp kusamama ve huzursuzluk görülürse saatler değil dakikalar önemlidir; vakit kaybetmeden veteriner hekime ulaşılması gereken bir tablodur.' },
