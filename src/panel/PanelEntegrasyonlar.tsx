...
export default function PanelEntegrasyonlar({ klinik, sahip, gorunum = 'technical' }: {
  klinik: string;
  sahip: boolean;
  ...
  if (yukleniyor) return <Yukleniyor metin={gorunum === 'technical' ? 'Entegrasyon ayarları yükleniyor' : 'İletişim operasyonları yükleniyor'} />;
