...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen pt-24 relative overflow-hidden">
      <SEO title={t('seo_title_blog')} description={t('seo_desc_blog')} />
      ...
      <div className="container mx-auto px-6 max-w-7xl py-12">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-4xl lg:text-5xl font-extrabold mb-6 text-[var(--text-main)]">{t('blog_h1')}</motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-xl text-[var(--text-muted)]">{t('blog_desc')}</motion.p>
        </div>
