              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="flex flex-col items-start z-10 w-full lg:w-1/2">
                ...
                <motion.h1 variants={fadeInUp} className="text-center md:text-left w-full font-extrabold leading-[1.1] tracking-tight mb-6 text-[var(--text-main)]">
                  <span className="text-3xl md:text-4xl lg:text-5xl leading-tight">
                    ...
                    <span className="block md:inline">{t('home_title_1_b')}</span>
        ...
        <section className="min-h-screen h-auto lg:h-screen snap-always snap-start py-24 lg:py-0 flex flex-col justify-center bg-[var(--bg-main)]">
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            <div className="text-center max-w-2xl lg:max-w-3xl mx-auto mb-16">
              ...
              <p className="text-base md:text-lg text-[var(--text-muted)] font-medium leading-relaxed">{t('home_why_sub1')}<br className="hidden md:block" />{t('home_why_sub2')}</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{once:true}} className="bg-white dark:bg-transparent border-2 border-indigo-100 dark:border-indigo-900 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden group hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-indigo-50 dark:bg-indigo-900/50 text-indigo-500 rounded-xl flex items-center justify-center mb-4 md:mb-6">
                  <LayoutGrid className="w-5 h-5 md:w-6 md:h-6" />
                </div>
                <h3 className="text-lg md:text-xl font-bold text-[var(--text-main)] mb-4 md:mb-6">{t('home_why_1_title')}</h3>
                <ul className="space-y-3 md:space-y-4">
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <User className="text-indigo-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_1_1')}</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <Stethoscope className="text-indigo-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_1_2')}</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <CheckCircle className="text-indigo-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_1_3')}</span>
                  </li>
                </ul>
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{once:true}} transition={{delay: 0.1}} className="bg-white dark:bg-transparent border-2 border-rose-100 dark:border-rose-900 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden group hover:border-rose-300 dark:hover:border-rose-700 transition-colors">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-rose-50 dark:bg-rose-900/50 text-rose-500 rounded-xl flex items-center justify-center mb-4 md:mb-6">
                  <Heart className="w-5 h-5 md:w-6 md:h-6" />
                </div>
                <h3 className="text-lg md:text-xl font-bold text-[var(--text-main)] mb-4 md:mb-6">{t('clinics_why_sec3_title')}</h3>
                <ul className="space-y-3 md:space-y-4">
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <User className="text-rose-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_2_1')}</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <Stethoscope className="text-rose-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_2_2')}</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <CheckCircle className="text-rose-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_2_3')}</span>
                  </li>
                </ul>
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{once:true}} transition={{delay: 0.2}} className="bg-white dark:bg-transparent border-2 border-sky-100 dark:border-sky-900 rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden group hover:border-sky-300 dark:hover:border-sky-700 transition-colors">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-sky-50 dark:bg-sky-900/50 text-sky-500 rounded-xl flex items-center justify-center mb-4 md:mb-6">
                  <Search className="w-5 h-5 md:w-6 md:h-6" />
                </div>
                <h3 className="text-lg md:text-xl font-bold text-[var(--text-main)] mb-4 md:mb-6">{t('home_why_3_title')}</h3>
                <ul className="space-y-3 md:space-y-4">
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <CheckCircle className="text-sky-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_3_1')}</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <CheckCircle className="text-sky-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_3_2')}</span>
                  </li>
                  <li className="flex items-start gap-2 md:gap-3 text-sm md:text-base text-[var(--text-muted)] font-medium">
                    <CheckCircle className="text-sky-500 shrink-0 mt-0.5 w-4 h-4 md:w-[18px] md:h-[18px]" /> <span>{t('home_why_3_3')}</span>
                  </li>
                </ul>
            ...
            <div className="flex flex-col items-center justify-center w-full px-4 mb-12">
              ...
              <p className="text-base md:text-xl text-[var(--text-muted)] max-w-xl lg:max-w-2xl font-medium leading-relaxed">
                ...
                <span className="block md:inline">
                  {t('home_dl_subtitle2_b')}
                  <br className="md:hidden" />
                  <span className="hidden md:inline"> </span>
                  <strong>{t('home_dl_subtitle3')}</strong>{' '}{t('home_dl_subtitle4')}
                </span>
              </p>
            </div>
