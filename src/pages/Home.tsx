      ...
      <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
            ...
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="flex flex-col items-start z-10">
              ...
              <motion.h1 variants={fadeInUp} className="text-5xl lg:text-7xl font-extrabold leading-tight tracking-tight mb-6 text-[var(--text-main)]">
                ...
                <span className="text-emerald-700 dark:text-emerald-400 underline decoration-amber-400 decoration-4 underline-offset-8">{t('home_hero_title2')}</span>
              </motion.h1>
              ...
              <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <a href="#download" className="btn-primary text-lg px-8 py-4 shadow-xl shadow-[var(--color-vet-primary)]/20 hover:shadow-[var(--color-vet-primary)]/40 hover:-translate-y-1 transition-all rounded-2xl flex items-center gap-2">
                  <ArrowRight size={20} /> {t('home_hero_dl')}
                </a>
                <Link to="/features" className="group flex items-center justify-center gap-2 px-8 py-4 rounded-2xl font-bold text-[var(--color-vet-primary)] dark:text-emerald-400 bg-white/50 dark:bg-white/10 hover:bg-white/80 dark:hover:bg-white/20 backdrop-blur-sm border border-emerald-900/10 transition-all">
                  <PlayCircle size={22} className="group-hover:scale-110 transition-transform" /> {t('home_hero_demo')}
                </Link>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div>
                  <div className="text-[var(--text-main)] font-bold text-sm">{t('home_w1_title')}</div>
                  <div className="text-emerald-600 dark:text-emerald-400 text-xs font-bold mt-1 bg-emerald-50 dark:bg-emerald-900/30 inline-block px-2 py-1 rounded-md">{t('home_w1_desc')}</div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <div className="text-[var(--text-main)] font-bold text-sm">{t('home_w2_title')}</div>
                  <div className="text-[var(--text-muted)] text-xs font-medium">{t('home_w2_desc')}</div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <div className="text-[var(--text-main)] font-bold text-sm">{t('home_w3_title')}</div>
                  <div className="text-[var(--text-muted)] text-[10px] font-medium">{t('home_w3_desc')}</div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <div className="text-[var(--text-main)] font-bold text-sm">{t('home_w4_title')}</div>
                  <div className="text-[var(--text-muted)] text-[11px] font-medium">{t('home_w4_desc')}</div>
                </div>
              </motion.div>
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-emerald-900/5 dark:divide-emerald-500/10">
              <div className="px-4 hover:-translate-y-1 transition-transform">
                <div className="text-4xl font-extrabold text-[var(--color-vet-primary)] dark:text-[var(--color-vet-primary-glow)] mb-1">50.000+</div>
                <div className="text-sm font-bold text-[var(--text-muted)] flex items-center justify-center gap-1">
                  <PawPrint size={14} className="text-amber-500"/> {t('home_stat1_desc')}
                </div>
              </div>
              <div className="px-4 hover:-translate-y-1 transition-transform">
                <div className="text-4xl font-extrabold text-[var(--color-vet-primary)] dark:text-[var(--color-vet-primary-glow)] mb-1">150+</div>
                <div className="text-sm font-bold text-[var(--text-muted)] flex items-center justify-center gap-1">
                  <Stethoscope size={14} className="text-blue-500"/> {t('home_stat2_desc')}
                </div>
              </div>
              <div className="px-4 hover:-translate-y-1 transition-transform">
                <div className="text-4xl font-extrabold text-[var(--color-vet-primary)] dark:text-[var(--color-vet-primary-glow)] mb-1">%99.8</div>
                <div className="text-sm font-bold text-[var(--text-muted)] flex items-center justify-center gap-1">
                  <Clock size={14} className="text-emerald-500"/> {t('home_stat3_desc')}
                </div>
              </div>
              <div className="px-4 hover:-translate-y-1 transition-transform">
                <div className="text-4xl font-extrabold text-[var(--color-vet-primary)] dark:text-[var(--color-vet-primary-glow)] mb-1">4.9 / 5.0</div>
                <div className="text-sm font-bold text-[var(--text-muted)] flex items-center justify-center gap-1">
                  <Star size={14} className="fill-amber-500 text-amber-500"/> {t('home_stat4_desc')}
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="ozellikler" className="py-32 container mx-auto px-6 max-w-7xl relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 text-[var(--text-main)]">{t('home_bento_h2_1')} <br/> {t('home_bento_h2_2')}</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 40 }} viewport={{ once: true }} className="lg:col-span-2 glass-card p-10 relative overflow-hidden group rounded-[3rem] hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-3xl font-bold text-[var(--text-main)] mb-3">{t('home_bento1_title')}</h3>
                ...
                <div className="mt-8 flex gap-4">
                  <div className="bg-white/90 dark:bg-gray-900/90 p-5 rounded-3xl shadow-sm border border-emerald-900/10 flex-1 flex items-center justify-between">
                    <div>
                      <div className="text-xs text-[var(--text-muted)] font-bold uppercase tracking-wider mb-1">{t('home_bento1_chip')}</div>
            ...
            <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 40 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="glass-card p-10 relative overflow-hidden group rounded-[3rem] hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-[var(--text-main)] mb-3">{t('home_bento2_title')}</h3>
                <p className="text-[var(--text-muted)] font-medium mb-6">{t('home_bento2_desc')}</p>
                ...
                <div className="mt-auto bg-white/90 dark:bg-gray-900/90 p-4 rounded-2xl border border-emerald-900/10 shadow-sm relative">
                   ...
                   <div className="text-sm font-bold text-red-500 mb-1">{t('home_bento2_alert')}</div>
                   <div className="font-bold text-[var(--text-main)]">{t('home_bento2_alert_desc')}</div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 40 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="glass-card p-10 relative overflow-hidden group rounded-[3rem] hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-[var(--text-main)] mb-3">{t('home_bento3_title')}</h3>
                <p className="text-[var(--text-muted)] font-medium mb-6">{t('home_bento3_desc')}</p>
                ...
                <button className="mt-auto w-full py-4 rounded-2xl bg-red-500 text-white font-bold flex items-center justify-center gap-2 hover:bg-red-600 transition-colors shadow-lg shadow-red-500/30">
                  <PhoneCall size={20} /> {t('home_bento3_btn')}
                </button>
              </div>
            </motion.div>
            ...
            <motion.div whileInView={{ opacity: 1, y: 0 }} initial={{ opacity: 0, y: 40 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="lg:col-span-2 glass-card p-10 relative overflow-hidden group rounded-[3rem] hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex-1 relative z-10">
                ...
                <h3 className="text-3xl font-bold text-[var(--text-main)] mb-4">{t('home_bento4_title')}</h3>
              ...
              <div className="w-full md:w-80 relative z-10 bg-white/90 dark:bg-gray-900/90 rounded-3xl p-5 shadow-xl border border-emerald-900/10 transform rotate-2 group-hover:rotate-0 transition-transform">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-bold text-sm">{t('home_bento4_author')}</div>
                    <div className="text-xs text-gray-500">{t('home_bento4_time')}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-sm">{likes} {t('home_bento4_likes')}</span>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <div className="flex-1 space-y-8">
                <h2 className="text-4xl lg:text-5xl font-extrabold text-[var(--text-main)] leading-tight">{t('home_clinics_h2_1')} <br/> {t('home_clinics_h2_2')}</h2>
        ...
        <section id="klinikler-icin" className="py-24 relative z-10">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="glass-card rounded-[3rem] p-10 lg:p-16 overflow-hidden relative">
              <div className="absolute -top-40 -right-40 w-96 h-96 bg-white/10 rounded-full blur-3xl animate-float"></div>
              
              <div className="flex flex-col lg:flex-row gap-12 items-center relative z-10">
                <div className="flex-1">
                  <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[var(--color-vet-primary)]/10 text-[var(--color-vet-primary)] dark:text-[var(--color-vet-primary-glow)] text-sm font-bold mb-8 backdrop-blur-md">
                    <Stethoscope size={16} /> {t('home_b2b_badge')}
                  </div>
                  <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 text-[var(--text-main)] leading-tight">{t('home_b2b_h2_1')}<br/> {t('home_b2b_h2_2')}</h2>
                  <p className="text-lg text-[var(--text-muted)] font-medium mb-10 max-w-xl leading-relaxed">
                    {t('home_b2b_desc')}
                  </p>
                  
                  <ul className="text-[var(--text-main)] space-y-4 mb-8 font-medium">
                    <li className="flex items-start gap-2"><CheckCircle2 size={20} className="text-[var(--color-vet-accent)] flex-shrink-0 mt-1" /> {t('home_b2b_li1')}</li>
                    <li className="flex items-start gap-2"><CheckCircle2 size={20} className="text-[var(--color-vet-accent)] flex-shrink-0 mt-1" /> {t('home_b2b_li2')}</li>
                    <li className="flex items-start gap-2"><CheckCircle2 size={20} className="text-[var(--color-vet-accent)] flex-shrink-0 mt-1" /> {t('home_b2b_li3')}</li>
                  </ul>
                  ...
                  <button className="bg-[var(--color-vet-accent)] hover:bg-[var(--color-vet-accent-light)] hover:text-[var(--text-main)] text-white font-bold text-lg px-8 py-4 rounded-2xl shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-2">
                    <CheckCircle2 size={20} /> {t('home_b2b_btn')}
                  </button>
                </div>
        ...
        <section id="yorumlar" className="py-24 relative z-10">
          <div className="container mx-auto px-6 max-w-7xl">
            <h2 className="text-4xl font-extrabold text-center mb-16">{t('home_stories_h2')}</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { name: t("home_story1_name"), breed: t("home_story1_breed"), text: t("home_story1_text") },
                { name: t("home_story2_name"), breed: t("home_story2_breed"), text: t("home_story2_text") },
                { name: t("home_story3_name"), breed: t("home_story3_breed"), text: t("home_story3_text") }
              ].map((story, i) => (
        ...
        <section id="blog" className="py-24 relative z-10">
          <div className="container mx-auto px-6 max-w-7xl">
            <h2 className="text-4xl font-extrabold text-center mb-16">{t('home_blog_h2')}</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: t("home_blog1_title"), img: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba", tag: t("home_blog1_cat"), time: t("home_blog1_time") },
                { title: t("home_blog2_title"), img: "https://images.unsplash.com/photo-1548199973-03cce0bbc87b", tag: t("home_blog2_cat"), time: t("home_blog2_time") },
                { title: t("home_blog3_title"), img: "https://images.unsplash.com/photo-1583337130417-3346a1be7dee", tag: t("home_blog3_cat"), time: t("home_blog3_time") }
              ].map((blog, i) => (
                <div key={i} className="glass-card rounded-[2.5rem] overflow-hidden group hover:-translate-y-2 transition-transform duration-300 flex flex-col cursor-pointer">
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto flex items-center gap-2 text-[var(--color-vet-primary)] font-bold text-sm">{t('home_blog_readmore')} <ArrowRight size={16}/></div>
                  </div>
                </div>
              ))}
            </div>
